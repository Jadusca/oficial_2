...
<head>
    ...
    <style>
        ...
        .btn { background-color: #007BFF; color: white; padding: 6px 10px; border: none; border-radius: 3px; cursor: pointer; margin-right: 5px; }
        ...
        .modal-content {
            ...
            border: 1px solid #888; width: 80%; max-height: 80vh; overflow-y: auto; border-radius: 5px;
        }
