...
elseif ($id_posgrado && !$id_tipo) {
    ...
    echo '<p style="padding: 20px;"><a href="posgrados.php">← Volver a lista de posgrados</a></p></div>';
}
...
elseif ($id_posgrado && $id_tipo) {
    ...
    echo "<p style='padding: 20px;'><a href='?posgrado=$id_posgrado'>← Volver a tipos de titulación</a></p>";
}
?>

<!-- Modal -->
<div id="modalFicha" class="modal" style="display:none; position: fixed; z-index: 1000; left: 0; top: 0; width: 100%; height: 100%; overflow: auto; background-color: rgba(0,0,0,0.6);">
    <div class="modal-content" style="background-color: #fff; margin: 10% auto; padding: 20px; border: 1px solid #888; width: 80%; max-height: 80vh; overflow-y: auto; border-radius: 5px;">
        <span class="close" onclick="cerrarModal()" style="color: #aaa; float: right; font-size: 28px; font-weight: bold;">&times;</span>
