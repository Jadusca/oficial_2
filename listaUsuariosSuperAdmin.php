                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<div class='nombrebotones'>
                                ...
                                <div class='botonestablauser'>
                                    <a class='botonazulfuerte' href='detalleuserSuperAdmin.php?idUsuario=$id'>Ver</a>
        ...
        $(document).ready(function () {
            $(".borrar-btn").click(function () {
                ...
                if (confirm("¿Estás seguro de que quieres eliminar este usuario?")) {
                    window.location.href = "borrarUsuario.php?idUsuario=" + userId + "&redirect=listaUsuariosSuperAdmin.php";
                }
            });
        });
    </script>
