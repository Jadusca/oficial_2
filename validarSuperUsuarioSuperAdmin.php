...
$stmt = $conectar->prepare("SELECT * FROM super_administradores WHERE usuario = ?");
...
if ($resultado->num_rows > 0) {
    ...
    if (password_verify($contrasena, $fila['contrasena'])) {
        $_SESSION['superadmin_id'] = $fila['id_super_administrador'];
        $_SESSION['superadmin_usuario'] = $fila['nombre'];
        $_SESSION['superadmin_genero'] = $fila['genero'];
