...
<body>
    ...
    <section class="editar ancho">
        ...
        <div class="formseditarcontra">
            <?php
            echo "<form method='post' class='formNuevoUsuario' action='actualizarContraseñaAdmin.php?id=$idDelUsuario'>";
            ?>
            <div class="editaruc">
    ...
    <script>
        ...
        function cancelarEdicionUsuario() {
            ...
            window.location = 'detalleuserSuperAdmin.php?idUsuario=' + idUsuario;
        }
    </script>
