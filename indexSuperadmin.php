...
<body>
    ...
    <section class="contprincipal ancho">
        ...
        <div class="direccionesprincipales">
            ...
            // echo "<a class='hvr-sweep-to-right' href='documentosRTS.php?tipoDocumento=Residencias'>Residencias</a>";
            echo "<a class='hvr-sweep-to-right' href='subir_archivos_super_admin.php'>Catálogo</a>";
            // echo "<a class='hvr-sweep-to-right' href='documentosRTS.php?tipoDocumento=Tesis'>Tesis</a>";
            // echo "<a class='hvr-sweep-to-right' href='documentosRTS.php?tipoDocumento=Sabatico'>Sabáticos</a>";
            ?>
        </div>
    </section>
    <br>
